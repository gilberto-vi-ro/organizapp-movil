...
class PendienteTab extends StatefulWidget {
  ...
  @override
  PendienteTabState createState() => PendienteTabState();
}

class PendienteTabState extends State<PendienteTab> {
  void initState() {
    super.initState();
  }
  ...
  String id_user = "1002",
      ...
      link =
          "https://myproyecto.com/organizapp-api/HomeController/listTaskPending/";
  /*------------------------------------------------------------------------------
  Constraint
  --------------------------------------------------------------------------------*/
  PendienteTabState() {
  ...
  // creamos nuestro metodo  _listWidgetActivida
  // --------------------------------------------------------------------------
